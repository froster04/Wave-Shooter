...
func _on_Enemy_spawn_timer_timeout():
	var enemy_position = Vector2(rand_range(-160,370),rand_range(-90,390))
	
	while enemy_position.x < 640 and enemy_position.x > -80 and enemy_position.y < 360 and enemy_position.y > -45:
		enemy_position = Vector2(rand_range(-160,370),rand_range(-90,390))
...
func _on_Difficulty_timer_timeout():
	if $Enemy_spawn_timer.wait_time > 0.5:
		$Enemy_spawn_timer.wait_time -= 0.025 #Difficulty
